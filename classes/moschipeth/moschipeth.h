...
/* MCS7830 based USB 2.0 Ethernet Devices */

#define UMCR_WRITE_REG           0x0d
#define UMCR_READ_REG            0x0e
#define UMCR_WRITE_REG_WITH_MASK 0x0f

/* Packet status error byte defines */
...
#define MCREG_MCAST_ADDR     0x00
#define MCREG_IPG0           0x08
#define MCREG_IPG1           0x09
#define MCREG_PHY_DATA_LOW   0x0a
#define MCREG_PHY_DATA_HIGH  0x0b
#define MCREG_PHY_ADDR       0x0c /* lower 4 bits contain phy address */
#define MCREG_PHY_CTRL       0x0d /* lower 4 bits contain phy register */
#define MCREG_CFG            0x0e
#define MCREG_ETH_ID         0x0f

#define MCRF_PHY_WRITE       0x20
#define MCRF_PHY_READ        0x40

#define MCRF_PHY_PENDING     0x80
#define MCRF_PHY_READY       0x40

#define MCRF_CFG_PROM        0x01
#define MCRF_CFG_MCAST       0x02
#define MCRF_CFG_SLEEP       0x04
#define MCRF_CFG_TXEN        0x08
#define MCRF_CFG_DUPLEX      0x20
#define MCRF_CFG_SPEED100    0x40
#define MCRF_CFG_OVERRIDE    0x80
