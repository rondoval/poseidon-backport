...
int libInit(struct NepBTBase * nh)
{
...
int libOpen(struct NepBTBase * nh)
{
...
int libExpunge(struct NepBTBase * nh)
{
    struct NepClassBT *ncp;
...
/* /// "usbGetAttrsA()" */
LONG (usbGetAttrsA)(ULONG type asm("d0"), APTR usbstruct asm("a0"), struct TagItem * tags asm("a1"), struct NepBTBase * nh asm("a6"))
{
...
/* /// "usbSetAttrsA()" */
LONG (usbSetAttrsA)(ULONG type asm("d0"), APTR usbstruct asm("a0"), struct TagItem * tags asm("a1"), struct NepBTBase * nh asm("a6"))
{
    return(0);
}
/* \\\ */
...
/* /// "usbDoMethodA()" */
IPTR (usbDoMethodA)(ULONG methodid asm("d0"), IPTR * methoddata asm("a1"), struct NepBTBase * nh asm("a6"))
{
    ...
    ncp->ncp_App = ApplicationObject,
        ...
        SubWindow, (IPTR)(ncp->ncp_MainWindow = WindowObject,
            ...
            WindowContents, (IPTR)VGroup,
                Child, (IPTR)HGroup, GroupFrameT((IPTR)(ncp->ncp_Interface ? "Device Settings" : "Default Device Settings")),
                    Child, (IPTR)HSpace(0),
                    Child, (IPTR)ColGroup(2),
                        Child, (IPTR)Label((IPTR) "Autostart BT Stack:"),
                        Child, (IPTR)HGroup,
                            Child, (IPTR)(ncp->ncp_StackAutoObj = ImageObject, ImageButtonFrame,
