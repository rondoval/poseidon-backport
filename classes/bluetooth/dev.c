...
DEVBASETYPEPTR (devOpen)(struct IOBTHCIReq * ioreq asm("a1"), ULONG unit asm("d0"), ULONG flags asm("d1"), struct NepBTDevBase * base asm("a6"))
{
...
BPTR (devClose)(struct IOBTHCIReq * ioreq asm("a1"), struct NepBTDevBase * base asm("a6"))
{
...
BPTR (devExpunge)(DEVBASETYPEPTR extralh asm("d0"), struct NepBTDevBase * base asm("a6"))
{
...
DEVBASETYPEPTR (devReserved)(struct NepBTDevBase * base asm("a6"))
{
    return NULL;
}

void (devBeginIO)(struct IOBTHCIReq * ioreq asm("a1"), struct NepBTDevBase * base asm("a6"))
{
...
LONG (devAbortIO)(struct IOBTHCIReq * ioreq asm("a1"), struct NepBTDevBase * base asm("a6"))
{
