...
int libExpunge(struct NepDFUBase * nh)
{
...
/* /// "usbGetAttrsA()" */
LONG (usbGetAttrsA)(ULONG type asm("d0"), APTR usbstruct asm("a0"), struct TagItem * tags asm("a1"), struct NepDFUBase * nh asm("a6"))
{
...
/* /// "usbSetAttrsA()" */
LONG (usbSetAttrsA)(ULONG type asm("d0"), APTR usbstruct asm("a0"), struct TagItem * tags asm("a1"), struct NepDFUBase * nh asm("a6"))
{
    return(0);
}
/* \\\ */
...
/* /// "usbDoMethodA()" */
IPTR (usbDoMethodA)(ULONG methodid asm("d0"), IPTR * methoddata asm("a1"), struct NepDFUBase * nh asm("a6"))
{
...
#define DOSBase nch->nch_DOSBase
    ...
    nch->nch_App = ApplicationObject,
        ...
        MUIA_Application_Description, (IPTR)"Settings for the dfu.class",
        MUIA_Application_Base       , (IPTR)"DFU",
        ...
        SubWindow, (IPTR)(nch->nch_MainWindow = WindowObject,
            ...
            WindowContents, (IPTR)VGroup,
                Child, (IPTR)VGroup, GroupFrameT((IPTR)"Firmware Upgrade/Download"),
                    Child, (IPTR)HGroup,
                        MUIA_ShowMe, nch->nch_DFUStatus.bState >= STATE_DFU_IDLE,
                        Child, (IPTR)Label((IPTR) "Firmware file:"),
                        Child, (IPTR)PopaslObject,
                            MUIA_Popstring_String, (IPTR)(nch->nch_FWFileObj = StringObject,
                                StringFrame,
                                MUIA_CycleChain, 1,
                            ...
                            ASLFR_TitleText, (IPTR)"Select a firmware binary file...",
                            ASLFR_InitialPattern, (IPTR)"#?.dfu",
                            ASLFR_DoPatterns, TRUE,
                            End,
                        End,
                    Child, (IPTR)(nch->nch_GaugeObj = GaugeObject,
                        MUIA_Frame, MUIV_Frame_ReadList,
                        MUIA_Gauge_Horiz, TRUE,
                        MUIA_Gauge_InfoText, (IPTR)infomsg,
                        MUIA_Gauge_Current, 0,
                        MUIA_Gauge_Max, 100,
                        End),
                    Child, (IPTR)HGroup,
                        MUIA_Group_SameWidth, TRUE,
                        Child, (IPTR)(nch->nch_DetachObj = TextObject, ButtonFrame,
                            MUIA_ShowMe, !nch->nch_DFUStatus.bState,
                            MUIA_Background, MUII_ButtonBack,
                            MUIA_CycleChain, 1,
                            MUIA_InputMode, MUIV_InputMode_RelVerify,
                            MUIA_Text_Contents, (IPTR)"\33c Enter DFU Mode ",
                            End),
                        Child, (IPTR)(nch->nch_DownloadObj = TextObject, ButtonFrame,
                            MUIA_ShowMe, nch->nch_DFUStatus.bState >= STATE_DFU_IDLE,
                            MUIA_Disabled, !nch->nch_CanRetrieve,
                            MUIA_Background, MUII_ButtonBack,
                            MUIA_CycleChain, 1,
                            MUIA_InputMode, MUIV_InputMode_RelVerify,
                            MUIA_Text_Contents, (IPTR)"\33c Download (Read) ",
                            End),
                        Child, (IPTR)(nch->nch_UploadObj = TextObject, ButtonFrame,
                            MUIA_ShowMe, nch->nch_DFUStatus.bState >= STATE_DFU_IDLE,
                            MUIA_Disabled, !nch->nch_CanUpgrade,
                            MUIA_Background, MUII_ButtonBack,
                            MUIA_CycleChain, 1,
                            MUIA_InputMode, MUIV_InputMode_RelVerify,
                            MUIA_Text_Contents, (IPTR)"\33c Upgrade (Write) ",
                            End),
                        End,
                    End,
                Child, (IPTR)VSpace(0),
