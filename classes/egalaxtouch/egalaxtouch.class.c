    ...
    nch->nch_App = ApplicationObject,
        ...
        SubWindow, (IPTR)(nch->nch_MainWindow = WindowObject,
            ...
            WindowContents, (IPTR)VGroup,
                Child, (IPTR)VGroup, GroupFrameT((IPTR)(nch->nch_Interface ? "Device Settings" : "Default Device Settings")),
                    Child, (IPTR)VGroup, GroupFrameT((IPTR)"Touchscreen Calibration"),
                        Child, (IPTR)ColGroup(4),
                            Child, (IPTR)Label((IPTR) "MinX:"),
                            Child, (IPTR)(nch->nch_MinXObj = SliderObject, SliderFrame,
                                MUIA_CycleChain, 1,
                                MUIA_Numeric_Min, 0,
                                MUIA_Numeric_Max, 1919,
                                MUIA_Numeric_Value, nch->nch_CDC->cdc_MinX,
                                End),
                            Child, (IPTR)Label((IPTR) "MaxX:"),
                            Child, (IPTR)(nch->nch_MaxXObj = SliderObject, SliderFrame,
                                MUIA_CycleChain, 1,
                                MUIA_Numeric_Min, 128,
                                MUIA_Numeric_Max, 2047,
                                MUIA_Numeric_Value, nch->nch_CDC->cdc_MaxX,
                                End),
                            Child, (IPTR)Label((IPTR) "MinY:"),
                            Child, (IPTR)(nch->nch_MinYObj = SliderObject, SliderFrame,
                                MUIA_CycleChain, 1,
                                MUIA_Numeric_Min, 0,
                                MUIA_Numeric_Max, 1919,
                                MUIA_Numeric_Value, nch->nch_CDC->cdc_MinY,
                                End),
                            Child, (IPTR)Label((IPTR) "MaxY:"),
                            Child, (IPTR)(nch->nch_MaxYObj = SliderObject, SliderFrame,
                                MUIA_CycleChain, 1,
                                MUIA_Numeric_Min, 128,
                                MUIA_Numeric_Max, 2047,
                                MUIA_Numeric_Value, nch->nch_CDC->cdc_MaxY,
                                End),
                            Child, (IPTR)Label((IPTR) "Mirror:"),
                            Child, (IPTR)(nch->nch_MirrorObj = CycleObject,
                                MUIA_Cycle_Entries, (IPTR)MirrorStrings,
                                MUIA_Cycle_Active, nch->nch_CDC->cdc_Mirror,
                                End),
                            Child, (IPTR)Label((IPTR) "Rotate:"),
                            Child, (IPTR)(nch->nch_RotateObj = CycleObject,
                                MUIA_Cycle_Entries, (IPTR)RotateStrings,
                                MUIA_Cycle_Active, nch->nch_CDC->cdc_Rotate,
                                End),
                            End,
                        Child, (IPTR)HGroup,
                            Child, (IPTR)(nch->nch_TrackDimsObj = ImageObject, ImageButtonFrame,
                                ...
                                End),
                            Child, (IPTR)Label((IPTR) "Track Dimensions by input (disables LMB/RMB)"),
                            Child, (IPTR)HSpace(0),
                            End,
                        End,
                    Child, (IPTR)ColGroup(2), GroupFrameT("Right Mouse Button Emulation"),
                        Child, (IPTR)Label((IPTR) "Mode:"),
                        Child, (IPTR)(nch->nch_RMBModeObj = CycleObject,
                            MUIA_Cycle_Entries, (IPTR)RMBModeStrings,
                            MUIA_Cycle_Active, nch->nch_CDC->cdc_RMBMode,
                            End),
                        Child, (IPTR)Label((IPTR) "Activation Delay:"),
                        Child, (IPTR)(nch->nch_RMBDelayObj = SliderObject, SliderFrame,
                            MUIA_CycleChain, 1,
                            MUIA_Numeric_Min, 5,
                            MUIA_Numeric_Max, 50,
                            ...
                            End),
                        Child, (IPTR)Label((IPTR) "Allowed Jitter:"),
                        Child, (IPTR)(nch->nch_RMBToleranceObj = SliderObject, SliderFrame,
                            MUIA_CycleChain, 1,
                            MUIA_Numeric_Min, 0,
                            MUIA_Numeric_Max, 100,
                            MUIA_Numeric_Value, nch->nch_CDC->cdc_RMBTolerance,
                            MUIA_Numeric_Format, (IPTR)"%ld units",
                            End),
                        End,
                    End,
                Child, (IPTR)VSpace(0),
