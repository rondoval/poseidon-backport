...
DEVBASETYPEPTR (devOpen)(struct IOExtPar * ioreq asm("a1"), ULONG unit asm("d0"), ULONG flags asm("d1"), struct NepPrtDevBase * base asm("a6"))
{
...
BPTR (devClose)(struct IOExtPar * ioreq asm("a1"), struct NepPrtDevBase * base asm("a6"))
{
...
BPTR (devExpunge)(DEVBASETYPEPTR extralh asm("d0"), struct NepPrtDevBase * base asm("a6"))
{
...
DEVBASETYPEPTR (devReserved)(struct NepPrtDevBase * base asm("a6"))
{
    return NULL;
}

void (devBeginIO)(struct IOExtPar * ioreq asm("a1"), struct NepPrtDevBase * base asm("a6"))
{
...
LONG (devAbortIO)(struct IOExtPar * ioreq asm("a1"), struct NepPrtDevBase * base asm("a6"))
{
