...
int libInit(struct NepPrinterBase * nh)
{
...
int libOpen(struct NepPrinterBase * nh)
{
...
int libExpunge(struct NepPrinterBase * nh)
{
...
/* /// "usbGetAttrsA()" */
LONG (usbGetAttrsA)(ULONG type asm("d0"), APTR usbstruct asm("a0"), struct TagItem * tags asm("a1"), struct NepPrinterBase * nh asm("a6"))
{
...
/* /// "usbSetAttrsA()" */
LONG (usbSetAttrsA)(ULONG type asm("d0"), APTR usbstruct asm("a0"), struct TagItem * tags asm("a1"), struct NepPrinterBase * nh asm("a6"))
{
    return(0);
}
/* \\\ */
...
/* /// "usbDoMethodA()" */
IPTR (usbDoMethodA)(ULONG methodid asm("d0"), IPTR * methoddata asm("a1"), struct NepPrinterBase * nh asm("a6"))
{
...
/*                Child, actionobj = NewObject(ActionClass->mcc_Class, 0,
                ...
                Child, (IPTR)ColGroup(2), GroupFrameT((IPTR) "Global Settings"),
                    Child, (IPTR)Label((IPTR) "Epson Init Sequence:"),
                    Child, (IPTR)HGroup,
                        Child, (IPTR)(nh->nh_EpsonInitObj = ImageObject, ImageButtonFrame,
                        ...
                        Child, (IPTR)HSpace(0),
                        End,
                    Child, (IPTR)Label((IPTR) "Enable SoftReset:"),
                    Child, (IPTR)HGroup,
                        Child, (IPTR)(nh->nh_SoftResetObj = ImageObject, ImageButtonFrame,
                            MUIA_Background, MUII_ButtonBack,
                            MUIA_CycleChain, 1,
                            MUIA_InputMode, MUIV_InputMode_Toggle,
                            MUIA_Image_Spec, MUII_CheckMark,
