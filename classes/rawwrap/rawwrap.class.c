        ...
        SubWindow, (IPTR)(ncp->ncp_MainWindow = WindowObject,
            ...
            WindowContents, (IPTR)VGroup,
                Child, (IPTR)RegisterGroup(ncp->ncp_Interface ? MainGUIPages : MainGUIPagesDefault),
                    ...
                    Child, (IPTR)HGroup, GroupFrameT((IPTR)"Global Settings"),
                        MUIA_Disabled, ncp->ncp_Interface ? TRUE : FALSE,
                        Child, (IPTR)HSpace(0),
                        Child, (IPTR)ColGroup(2),
                            Child, (IPTR)Label((IPTR) "Bind to Vendor/Unknown Interfaces:"),
                            Child, (IPTR)HGroup,
                                Child, (IPTR)(ncp->ncp_BindVendorObj = ImageObject, ImageButtonFrame,
                                ...
                                Child, (IPTR)HSpace(0),
                                End,
                            Child, (IPTR)Label((IPTR) "Bind to all interfaces:"),
                            Child, (IPTR)HGroup,
                                Child, (IPTR)(ncp->ncp_BindAllObj = ImageObject, ImageButtonFrame,
                                    MUIA_Background, MUII_ButtonBack,
                                    MUIA_CycleChain, 1,
                                    MUIA_InputMode, MUIV_InputMode_Toggle,
                                    MUIA_Image_Spec, MUII_CheckMark,
                    ...
                    Child, (IPTR)ColGroup(2), GroupFrameT((IPTR)(ncp->ncp_Interface ? "Device Settings" : "Default Device Settings")),
                        ...
                        Child, (IPTR)HGroup,
                            Child, (IPTR)(ncp->ncp_UnitObj = StringObject,
                                ...
                                End),
                            Child, (IPTR)HSpace(0),
                            Child, (IPTR)Label((IPTR) "Exclusive access:"),
                            Child, (IPTR)(ncp->ncp_UnitExclObj = ImageObject, ImageButtonFrame,
                                MUIA_Background, MUII_ButtonBack,
                                MUIA_CycleChain, 1,
                                MUIA_InputMode, MUIV_InputMode_Toggle,
                                MUIA_Image_Spec, MUII_CheckMark,
                                ...
                                End),
                            End,
                        Child, (IPTR)Label((IPTR) "Out NAK Timeout:"),
                        Child, (IPTR)(ncp->ncp_OutNakTimeoutObj = SliderObject, SliderFrame,
                            MUIA_CycleChain, 1,
                            MUIA_Numeric_Min, 0,
                            ...
                            End),
                        Child, (IPTR)Label((IPTR) "In NAK Timeout:"),
                        Child, (IPTR)(ncp->ncp_InNakTimeoutObj = SliderObject, SliderFrame,
                            MUIA_CycleChain, 1,
                            MUIA_Numeric_Min, 0,
                            MUIA_Numeric_Max, 600,
                            ...
                            MUIA_Numeric_Format, (IPTR)"%ld00ms",
                            End),
                        Child, (IPTR)Label((IPTR) "In Buffer Mode:"),
                        Child, (IPTR)HGroup,
                            Child, (IPTR)(ncp->ncp_InBufferModeObj = CycleObject,
                                MUIA_CycleChain, 1,
                                MUIA_Cycle_Entries, (IPTR)BufferModeStrings,
                                MUIA_Cycle_Active, ncp->ncp_CDC->cdc_InBufferMode,
                                End),
                            Child, (IPTR)Label((IPTR) "Buffer Size:"),
                            Child, (IPTR)(ncp->ncp_InBufferSizeObj = SliderObject, SliderFrame,
                                MUIA_CycleChain, 1,
                                MUIA_Numeric_Min, 1,
                                MUIA_Numeric_Max, 512,
                                MUIA_Numeric_Value, ncp->ncp_CDC->cdc_InBufferSize,
                                MUIA_Numeric_Format, (IPTR)"%ldKB",
                                End),
                            End,
                        Child, (IPTR)Label((IPTR) "Short Reads Terminate:"),
                        Child, (IPTR)HGroup,
                            Child, (IPTR)(ncp->ncp_ShortReadTermObj = ImageObject, ImageButtonFrame,
                                MUIA_Background, MUII_ButtonBack,
                                MUIA_CycleChain, 1,
                                MUIA_InputMode, MUIV_InputMode_Toggle,
                                MUIA_Image_Spec, MUII_CheckMark,
