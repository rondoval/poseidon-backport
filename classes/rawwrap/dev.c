...
DEVBASETYPEPTR (devOpen)(struct IOStdReq * ioreq asm("a1"), ULONG unit asm("d0"), ULONG flags asm("d1"), struct NepRawDevBase * base asm("a6"))
{
...
BPTR (devClose)(struct IOStdReq * ioreq asm("a1"), struct NepRawDevBase * base asm("a6"))
{
...
BPTR (devExpunge)(DEVBASETYPEPTR extralh asm("d0"), struct NepRawDevBase * base asm("a6"))
{
...
DEVBASETYPEPTR (devReserved)(struct NepRawDevBase * base asm("a6"))
{
    return NULL;
}

void (devBeginIO)(struct IOStdReq * ioreq asm("a1"), struct NepRawDevBase * base asm("a6"))
{
...
LONG (devAbortIO)(struct IOStdReq * ioreq asm("a1"), struct NepRawDevBase * base asm("a6"))
{
