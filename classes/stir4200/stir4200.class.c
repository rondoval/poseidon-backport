    ...
    ncp->ncp_App = ApplicationObject,
        ...
        SubWindow, (IPTR)(ncp->ncp_MainWindow = WindowObject,
            ...
            WindowContents, (IPTR)VGroup,
                Child, (IPTR)HGroup, GroupFrameT((IPTR)(ncp->ncp_Device ? "Device Settings" : "Default Device Settings")),
                    Child, (IPTR)HSpace(0),
                    Child, (IPTR)ColGroup(2),
                        Child, (IPTR)Label((IPTR) "Autostart IrDA Stack:"),
                        Child, (IPTR)HGroup,
                ...
                Child, (IPTR)HGroup,
                    ...
                    Child, (IPTR)(ncp->ncp_UseObj = TextObject, ButtonFrame,
                        MUIA_ShowMe, (IPTR)ncp->ncp_Device,
                        MUIA_Background, MUII_ButtonBack,
                        MUIA_CycleChain, 1,
                    ...
                    Child, (IPTR)(ncp->ncp_SetDefaultObj = TextObject, ButtonFrame,
                        ...
                        MUIA_CycleChain, 1,
                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                        MUIA_Text_Contents, (IPTR)(ncp->ncp_Device ? "\33c Save as Default " : "\33c Save Defaults "),
                        End),
